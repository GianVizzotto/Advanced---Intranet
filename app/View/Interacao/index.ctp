        ...
        <div class="conteudo">
        	...
        	<div style="padding:20px;">
				...
				<div class="funcionario_do_mes">
					...
					<a class="bt_padrao" href="<?php echo '/ramais?dpto_aviso='.$mes[0]['Departamentos']['id'].'&func_aviso='.$mes[0]['Usuarios']['id'] ?>">Envie uma Mensagem para ele</a>
				...
				<div class="funcionario_do_mes">
					...
					<?php echo $merito[0]['Usuarios_merito']['conteudo']; ?>
				       ...
				       <a class="bt_padrao" href="<?php echo '/ramais?dpto_aviso='.$merito[0]['Departamentos']['id'].'&func_aviso='.$merito[0]['Usuarios']['id'] ?>">Envie uma Mensagem para ele</a>
