...
<div id="meio">
	<div id="colunaE" style=" width: 950px;">
		<?php if($id):?>
			<h1>EDI&Ccedil;&Atilde;O DE AJUDA</h1>
		<?php else:?>
			<h1>NOVA AJUDA</h1>
		<?php endif; ?> 
		<div class="conteudo" style=" width: 910px;">
			<div class="formulario">
 				...
 				<?php echo $this->Form->create('Ajuda', array ('enctype' => 'multipart/form-data') ); ?>
					...
					<label for="Tipos">
						...
						<?php echo $this->Form->input('tipos_ajudas_id' , array ( 'options' => $Tipos_ajudas , 'label' => false) ) ;?> 
					</label> 
					<br />   
...
<script type="text/javascript">
  var ck_newsContent = CKEDITOR.replace( 'data[Ajuda][conteudo]', {toolbar : [
