...
<div id="meio">
	<div id="colunaE" style=" width: 950px;">
		<?php if($id):?>
			<h1>EDI&Ccedil;&Atilde;O DE MÉRITO</h1>
		<?php else:?>
			<h1>NOVA MÉRITO</h1>
		<?php endif; ?> 
		<div class="conteudo" style=" width: 910px;">
			<div class="formulario">
 				...
 				<?php echo $this->Form->create('Usuarios_merito', array ('enctype' => 'multipart/form-data') ); ?>
...
<script type="text/javascript">
  var ck_newsContent = CKEDITOR.replace( 'data[Usuarios_merito][conteudo]', {toolbar : [
